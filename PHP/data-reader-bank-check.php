...
while ($row = $res->fetch_assoc())
{
    ...
    $html .= "<td>
                <form action='buy-prod.php' method='POST' style='width: min-content;'>
                    ...
                    <div class='row'>
                        <input style='width: 90px;' type='number' class='form-control mb-2 mx-auto input-lg' name='check-val' min='1'>
                    </div>
                    <div class='row'>
                        <button class=\"btn btn-info btn-lg\" name=\"check-pay\"><i class=\"bi bi-plus-square\"></i></button>
                    </div>
                </form>
            </td>";
    $html .= '<td>';
